    ...
    <form method="post" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <input
                type="email"
                name="email"
                value="<?php echo deDanger($oldFormData["email"] ?? ""); ?>"
        ...
        <label class="block">
            ...
            <input
                type="number"
                name="age"
                value="<?php echo deDanger($oldFormData["age"] ?? ""); ?>"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                placeholder="" />
        ...
        <label class="block">
            ...
            <select name="country"
                ...
                <option value="Canada" <?php if ($oldFormData["country"] == "Canada") echo "selected"; ?>>Canada</option>
                <option value="Mexico" <?php if ($oldFormData["country"] == "Mexico") echo "selected"; ?>>Mexico</option>
        ...
        <label class="block">
            ...
            <input
                name="socialMediaURL"
                type="text"
                value="<?php echo deDanger($oldFormData["socialMediaURL"] ?? ""); ?>"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                placeholder="" />
            ...
            <div class="mt-2">
                <div>
                    <label class="inline-flex items-center">
                        <input
                            name="tos"
                            <?php if ($oldFormData["tos"]) echo "checked"; ?>
